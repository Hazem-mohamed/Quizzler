...
import Foundation
// This Class Will Store All Of Question That We Will Use In Our App
class QuestionBank{
    // Creat Emptye Array Of Type Question
    var list = [Question]()
    ...
    init(){
        ...
        // skipping one step and just creating the quiz item inside the append function (On The Flye)
